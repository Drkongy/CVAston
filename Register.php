                       ...
                       if($password == $confirm_password){
                           ...
                           if (mysqli_num_rows($result) > 0) {
                               ...
                               if($emailUsed == false) {
                                   ...
                                   $sql = "INSERT INTO cvs (name, email, password) VALUES ('$name', '$email', '$hashed_password')";
                     ...
                     <div class="register-body">
                        <form action="Register.php" method="post">
                           <div class="form-group">
                              <input type="text" name="name" id="name" class="control" placeholder="Name" required>
                           </div>
                           <div class="form-group">
                              <input type="email" name="email" id="email" class="form-control" placeholder="Email" required>
                           </div>
                           <div class="form-group">
                              <input type="email" name="confirm-email" id="confirm-email" class="form-control" placeholder="Confirm Email" required>
                           </div>
                           <div class="form-group">
